...
from kakao_map_location import sungbuk
...
sungbuk.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시_성북구_폐형광등폐건전지수거함_20190823.csv", "parsed_csv/lamp_battery/sungbuk.csv")#, "parsed_csv/lamp_battery/missed.csv")