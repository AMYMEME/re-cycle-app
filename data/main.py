...
from kakao_map_location import yangcheon
...
yangcheon.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시_양천구_폐건전지폐형광등분리수거함_20200826.csv", "parsed_csv/lamp_battery/yangcheon.csv", "parsed_csv/lamp_battery/missed.csv")