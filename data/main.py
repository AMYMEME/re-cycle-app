...
from kakao_map_location import songpa
...
songpa.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시_송파구_폐형광등 폐건전지 분리수거함 위치_20200615.csv", "parsed_csv/lamp_battery/songpa.csv", "parsed_csv/lamp_battery/missed.csv")