...
from kakao_map_location import geumcheon
...
geumcheon.get_lamp_battery_csv_data("raw_data/lamp_battery/xls/서울특별시_금천구_폐형광등 수거함 현황.csv", "parsed_csv/lamp_battery/geumcheon.csv", "parsed_csv/lamp_battery/missed.csv")