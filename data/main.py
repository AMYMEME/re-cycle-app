...
from kakao_map_location import guro
...
guro.get_lamp_battery_csv_data("raw_data/lamp_battery/xls/서울특별시-구로구_폐형광등폐건전지분리수거함_20200131.csv", "parsed_csv/lamp_battery/guro.csv", "parsed_csv/lamp_battery/missed.csv")