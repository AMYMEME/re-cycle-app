...
gwangjin.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시 광진구_폐형광등, 폐건전지 수거함 현황_20190820..csv", "parsed_csv/lamp_battery/gwangjin.csv", "parsed_csv/lamp_battery/missed.csv")