...
from kakao_map_location import jungrang
...
jungrang.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시_중랑구_폐건전지폐형광등분리수거함_20201106.csv", "parsed_csv/lamp_battery/jungrang.csv", "parsed_csv/lamp_battery/missed.csv")