...
from kakao_map_location import gangbuk
...
gangbuk.get_lamp_battery_csv_data("raw_data/lamp_battery/xls/강북구_폐형광등_폐건전지.csv", "parsed_csv/lamp_battery/gangbuk.csv", "parsed_csv/lamp_battery/missed.csv")