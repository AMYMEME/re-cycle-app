...
from kakao_map_location import gwanak
...
gwanak.get_lamp_battery_csv_data("raw_data/lamp_battery/csv/서울특별시 관악구_폐형광등 및 폐건전지 분리수거함_2019..csv", "parsed_csv/lamp_battery/gwanak.csv", "parsed_csv/lamp_battery/missed.csv")